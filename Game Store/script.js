...
day_night2.addEventListener('click', () => {
    document.documentElement.style.setProperty('--color-1', '#2b2b2d');
    document.documentElement.style.setProperty('--color-2', '#fff');
    document.documentElement.style.setProperty('--color-3', '#1e1d1d');
...
play.addEventListener('click', () => {
    if (video.paused || video.currenTime <= 0) {
        video.play();
